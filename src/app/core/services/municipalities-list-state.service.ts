...
import { SortColumn, SortDirection } from '../../shared/types/sort.types';
import {
  DEFAULT_PAGE,
  DEFAULT_SORT_COLUMN,
...
export class MunicipalitiesListStateService {
  private searchMunicipalitesService = inject(SearchMunicipalites);
  ...
  readonly itemsPerPage = PAGINATION_ITEMS_PER_PAGE;
  searchTerm = signal<string>('');
  private searchSubject = new Subject<string>();

  constructor() {
    // Load municipalities when codeDepartment changes
    toObservable(this.codeDepartment)
      .pipe(
  ...
  setCodeDepartment(codeDepartment: string): void {
    this.codeDepartment.set(codeDepartment);
  }
